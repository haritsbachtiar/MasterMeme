...
import com.haritsbachtiar.mastermeme.LIGHT_GRAY_C0LOR
import com.haritsbachtiar.mastermeme.SCRIM_COLOR
import com.haritsbachtiar.mastermeme.SURFACE_CONTAINER_LOW_COLOR
...
fun TemplateMemeBottomSheet(
    ...
    ModalBottomSheet(
        ...
        MemeListView(data = data, showTopGradient = false)
    }
}